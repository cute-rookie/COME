...
def main(file_name=None):
    ...
    parser.add_argument('--ta', default=3, choices=range(1, 41), help='target attribute')
    parser.add_argument('--sa', default=21, choices=range(1, 41), help='sensitive attribute')
    ...
    parser.add_argument('--low_confidence_threshold', default=0.35, type=float, help='the confidence threshold for low confidence samples in CLIP')
    parser.add_argument('--high_confidence_threshold', default=0.97, type=float, help='the confidence threshold for high confidence samples in LLM annotation')
    ...
    parser.add_argument('--final_feature', default=5.0e-4, type=float, help='loss hyperparameter for MI final feature')
    parser.add_argument('--lvl', default=0.5, type=float, help='loss hyperparameter for level-wise classification')
    parser.add_argument('--attributes_feature', default=5.0e-4, type=float, help='loss hyperparameter for MI attributes feature')
