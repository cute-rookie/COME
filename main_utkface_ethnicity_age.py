...
def main(file_name=None):
    ...
    parser.add_argument('--final_feature', default=5e-4, type=float, help='loss hyperparameter for MI final feature')
    parser.add_argument('--lvl', default=0.5, type=float, help='loss hyperparameter for level-wise classification')
    parser.add_argument('--attributes_feature', default=5e-4, type=float, help='loss hyperparameter for MI attributes feature')
